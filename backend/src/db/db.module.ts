...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      entities: [User, Account, AccountCredential, AccountSnapshot, Post, SyncJob, CompetitorRun, CompetitorSuggestion],
      synchronize: process.env.NODE_ENV === 'test',
    }),
    TypeOrmModule.forFeature([User, Account, AccountCredential, AccountSnapshot, Post, SyncJob, CompetitorRun, CompetitorSuggestion]),
  ],
